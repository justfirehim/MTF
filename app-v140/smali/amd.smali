...
.method public final a()Lama;
    ...
    .line 72
    new-instance v0, Lamd$a;

    invoke-direct {v0, v3}, Lamd$a;-><init>(B)V
    ...
    .line 76
    :try_start_1
    iget-object v3, p0, Lamd;->a:Landroid/content/Context;
    ...
    .line 78
    :try_start_2
    new-instance v1, Lamd$b;

    .line 79
    invoke-virtual {v0}, Lamd$a;->a()Landroid/os/IBinder;

    move-result-object v3

    invoke-direct {v1, v3}, Lamd$b;-><init>(Landroid/os/IBinder;)V

    .line 80
    new-instance v3, Lama;

    invoke-virtual {v1}, Lamd$b;->a()Ljava/lang/String;

    move-result-object v4

    .line 81
    invoke-virtual {v1}, Lamd$b;->b()Z

    move-result v1

    invoke-direct {v3, v4, v1}, Lama;-><init>(Ljava/lang/String;Z)V
    :try_end_2
    ...
    .line 87
    :try_start_3
    iget-object v1, p0, Lamd;->a:Landroid/content/Context;
    ...
    invoke-interface {v3, v4, v5, v1}, Lalt;->b(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    :try_end_4
    ...
    invoke-interface {v1, v3, v4, v0}, Lalt;->a(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
