...
.field final fileStore:Laob;


# direct methods
.method public constructor <init>(Landroid/content/Context;Laob;)V
    .locals 0
    ...
    .line 27
    iput-object p2, p0, Lcom/crashlytics/android/answers/AnswersFilesManagerProvider;->fileStore:Laob;
...
.method public getAnalyticsFilesManager()Lcom/crashlytics/android/answers/SessionAnalyticsFilesManager;
    ...
    .line 43
    iget-object v2, p0, Lcom/crashlytics/android/answers/AnswersFilesManagerProvider;->fileStore:Laob;

    invoke-interface {v2}, Laob;->a()Ljava/io/File;
    ...
    invoke-direct {v3, v4, v2, v5, v6}, Lans;-><init>(Landroid/content/Context;Ljava/io/File;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-direct {v2, v4, v0, v1, v3}, Lcom/crashlytics/android/answers/SessionAnalyticsFilesManager;-><init>(Landroid/content/Context;Lcom/crashlytics/android/answers/SessionEventTransform;Lamj;Lano;)V
