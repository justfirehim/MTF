...
.method private doWriteToLog(JLjava/lang/String;)V
    ...
    .line 135
    iget-object v0, p0, Lcom/crashlytics/android/core/QueueFileLogStore;->logFile:Lamt;
    ...
    .line 171
    iget-object p2, p0, Lcom/crashlytics/android/core/QueueFileLogStore;->logFile:Lamt;

    invoke-virtual {p2, p1}, Lamt;->a([B)V

    .line 174
    :goto_0
    iget-object p1, p0, Lcom/crashlytics/android/core/QueueFileLogStore;->logFile:Lamt;

    invoke-virtual {p1}, Lamt;->b()Z
...
.method private getLogBytes()Lcom/crashlytics/android/core/QueueFileLogStore$LogBytes;
    ...
    .line 92
    :try_start_0
    iget-object v3, p0, Lcom/crashlytics/android/core/QueueFileLogStore;->logFile:Lamt;
    ...
    invoke-virtual {v3, v4}, Lamt;->a(Lamt$c;)V
    :try_end_0
    .catch Ljava/io/IOException; {:try_start_0 .. :try_end_0} :catch_0
...
.method private openLogFile()V
    ...
    invoke-direct {v0, v1}, Lamt;-><init>(Ljava/io/File;)V

    iput-object v0, p0, Lcom/crashlytics/android/core/QueueFileLogStore;->logFile:Lamt;
    :try_end_0
    .catch Ljava/io/IOException; {:try_start_0 .. :try_end_0} :catch_0
