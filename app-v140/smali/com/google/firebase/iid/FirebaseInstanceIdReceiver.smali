...
.method private static a(Landroid/content/BroadcastReceiver;Landroid/content/Context;Ljava/lang/String;Landroid/content/Intent;)I
    ...
    invoke-virtual {v0, p1, p2, p3}, Lahs;->b(Landroid/content/Context;Ljava/lang/String;Landroid/content/Intent;)I
...
.method private static declared-synchronized a(Landroid/content/Context;Ljava/lang/String;)Laid;
    .locals 2
    ...
    .line 51
    sget-object v1, Lcom/google/firebase/iid/FirebaseInstanceIdReceiver;->b:Laid;
    ...
    invoke-direct {v1, p0, p1}, Laid;-><init>(Landroid/content/Context;Ljava/lang/String;)V

    sput-object v1, Lcom/google/firebase/iid/FirebaseInstanceIdReceiver;->b:Laid;

    .line 53
    :cond_0
    sget-object p0, Lcom/google/firebase/iid/FirebaseInstanceIdReceiver;->b:Laid;
    :try_end_0
    ...
    :cond_1
    :try_start_1
    sget-object v1, Lcom/google/firebase/iid/FirebaseInstanceIdReceiver;->a:Laid;
    ...
    sput-object v1, Lcom/google/firebase/iid/FirebaseInstanceIdReceiver;->a:Laid;

    .line 56
    :cond_2
    sget-object p0, Lcom/google/firebase/iid/FirebaseInstanceIdReceiver;->a:Laid;
    :try_end_1
...
.method private static b(Landroid/content/BroadcastReceiver;Landroid/content/Context;Ljava/lang/String;Landroid/content/Intent;)I
    ...
    .line 48
    :cond_2
    invoke-static {p1, p2}, Lcom/google/firebase/iid/FirebaseInstanceIdReceiver;->a(Landroid/content/Context;Ljava/lang/String;)Laid;
    ...
    invoke-virtual {p1, p3, p0}, Laid;->a(Landroid/content/Intent;Landroid/content/BroadcastReceiver$PendingResult;)V
