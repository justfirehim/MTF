...
.method private constructor <init>()V
    ...
    iput-object v0, p0, Lahs;->d:Landroid/support/v4/util/SimpleArrayMap;

    const/4 v0, 0x0

    .line 6
    iput-object v0, p0, Lahs;->e:Ljava/lang/Boolean;
    ...
    iput-object v0, p0, Lahs;->b:Ljava/util/Queue;
...
.method private final a(Landroid/content/Context;Landroid/content/Intent;)I
    ...
    .line 34
    iget-object v0, p0, Lahs;->d:Landroid/support/v4/util/SimpleArrayMap;

    monitor-enter v0

    .line 35
    :try_start_0
    iget-object v1, p0, Lahs;->d:Landroid/support/v4/util/SimpleArrayMap;
    ...
    :cond_3
    :goto_0
    iget-object v2, p0, Lahs;->d:Landroid/support/v4/util/SimpleArrayMap;

    monitor-enter v2

    .line 49
    :try_start_1
    iget-object v3, p0, Lahs;->d:Landroid/support/v4/util/SimpleArrayMap;
    ...
    :goto_4
    :try_start_2
    iget-object v1, p0, Lahs;->e:Ljava/lang/Boolean;
    ...
    .line 58
    :cond_a
    iget-object v0, p0, Lahs;->e:Ljava/lang/Boolean;
...
.method public static declared-synchronized a()Lahs;
    .locals 2
...
.method public static a(Landroid/content/Context;ILandroid/content/Intent;)Landroid/app/PendingIntent;
    ...
    .line 10
    invoke-static {p0, v0, p2}, Lahs;->a(Landroid/content/Context;Ljava/lang/String;Landroid/content/Intent;)Landroid/content/Intent;
...
.method public final b(Landroid/content/Context;Ljava/lang/String;Landroid/content/Intent;)I
    ...
    .line 26
    :pswitch_0
    iget-object v0, p0, Lahs;->b:Ljava/util/Queue;
    ...
    .line 32
    invoke-direct {p0, p1, p3}, Lahs;->a(Landroid/content/Context;Landroid/content/Intent;)I
